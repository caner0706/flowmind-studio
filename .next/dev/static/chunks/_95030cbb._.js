...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set)=>({
        ...
        register: async (email, password, name)=>{
            ...
            if (response.error) {
                ...
                // Bu durumda kullanıcıyı email doğrulama sayfasına yönlendirebiliriz
                const errorMessage = response.error.message || "";
                if (errorMessage.toLowerCase().includes("user created") || errorMessage.toLowerCase().includes("kullanıcı oluşturuldu")) {
                    console.log("ℹ️ Kullanıcı oluşturuldu ama email gönderilemedi, email doğrulama sayfasına yönlendirilecek");
                    set({
                        isLoading: false,
                        error: null
                    });
                    return true; // Başarılı say, yönlendirme yapılsın
                }
                set({
                    error: response.error.message,
                    isLoading: false,
                ...
                console.log("❌ Register false döndürüyor (error var)");
                return false;
            }
        ...
        forgotPassword: async (email)=>{
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].forgotPassword(email);
            if (response.error) {
                set({
                    error: response.error.message,
                    isLoading: false
        ...
        resetPassword: async (token, newPassword)=>{
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].resetPassword(token, newPassword);
            if (response.error) {
                set({
                    error: response.error.message,
                    isLoading: false
        ...
        verifyEmail: async (email, code)=>{
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].verifyEmail(email, code);
            if (response.error) {
                set({
                    error: response.error.message,
                    isLoading: false
        ...
        resendVerificationCode: async (email)=>{
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].resendVerificationCode(email);
            if (response.error) {
                set({
                    error: response.error.message,
                    isLoading: false
...
function VerifyEmailPage() {
    ...
    const { verifyEmail, isLoading, error, clearError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        // Validation
        if (!code) {
            setLocalError("Doğrulama kodu gereklidir");
            return;
        }
        if (code.length !== 6) {
        ...
        if (success) {
            console.log("✅ Email doğrulama başarılı!");
            setSuccess(true);
        ...
        // Hata zaten store'da set edildi, displayError'da gösterilecek
        }
    };
    const handleResend = ()=>{
        setLocalError(null);
        setResendSuccess(false);
        // Frontend'de yeni kod oluştur
        ...
        console.log("✅ Yeni doğrulama kodu oluşturuldu.");
        console.log("🔑 Yeni Doğrulama Kodu (TEST):", verificationCode);
        console.log("💡 Bu kod sadece test için gösteriliyor. Production'da email ile gönderilecek.");
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "Hesabınız başarıyla aktifleştirildi. Giriş sayfasına yönlendiriliyorsunuz..."
                        }, void 0, false, {
                            fileName: "[project]/app/verify-email/page.tsx",
                            lineNumber: 99,
                            columnNumber: 13
                        ...
                        children: [
                            ...
                            resendSuccess && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Doğrulama kodu tekrar gönderildi!"
                                }, void 0, false, {
                                    fileName: "[project]/app/verify-email/page.tsx",
                                    lineNumber: 141,
                                    columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                ...
                                                value: code,
                                                onChange: (e)=>{
                                                    // Sadece rakamları kabul et ve maksimum 6 karakter
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "6 haneli doğrulama kodunu giriniz (Email adresinize gönderilen kodu giriniz)"
                                    }, void 0, false, {
                                        fileName: "[project]/app/verify-email/page.tsx",
                                        lineNumber: 169,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: isLoading ? "Doğrulanıyor..." : "Doğrula"
                            }, void 0, false, {
                                fileName: "[project]/app/verify-email/page.tsx",
                                lineNumber: 175,
                                columnNumber: 13
...
_s(VerifyEmailPage, "mwCQbbnYilEH1GCxdzm96oLlYhg=", false, function() {
    return [
...
//# sourceMappingURL=_95030cbb._.js.map