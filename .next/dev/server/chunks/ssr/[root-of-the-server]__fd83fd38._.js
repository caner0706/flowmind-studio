...
function VerifyEmailPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // Sayfa yüklendiğinde localStorage'dan kodu kontrol et ve göster
        const verificationData = localStorage.getItem("email-verification");
        if (verificationData) {
            try {
                const data = JSON.parse(verificationData);
                if (data.email === email && Date.now() <= data.expiresAt) {
                    // Kod hala geçerli, göster
                    setShowCode(true);
                }
            } catch (err) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // Frontend'de doğrulama kodu kontrolü
            const verificationData = localStorage.getItem("email-verification");
            if (!verificationData) {
                setLocalError("Doğrulama kodu bulunamadı. Lütfen kodu tekrar gönderin.");
                setIsLoading(false);
                return;
            }
            const data = JSON.parse(verificationData);
            // Email kontrolü
            if (data.email !== email) {
                setLocalError("Email adresi eşleşmiyor.");
                setIsLoading(false);
                return;
            }
            // Süre kontrolü
            if (Date.now() > data.expiresAt) {
                setLocalError("Doğrulama kodu süresi dolmuş. Lütfen kodu tekrar gönderin.");
            ...
            // Kod kontrolü
            if (data.code !== code) {
                setLocalError("Doğrulama kodu hatalı. Lütfen tekrar deneyin.");
                setIsLoading(false);
                return;
            }
            // Kod doğru, localStorage'dan sil
            localStorage.removeItem("email-verification");
            setShowCode(false);
            ...
            setLocalError("Doğrulama işlemi sırasında bir hata oluştu. Lütfen tekrar deneyin.");
            setIsLoading(false);
        }
    };
    const handleResend = ()=>{
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "6 haneli doğrulama kodunu giriniz"
                                    }, void 0, false, {
                                        fileName: "[project]/app/verify-email/page.tsx",
                                        lineNumber: 222,
                                        columnNumber: 15
                                    ...
                                    showCode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "p-3 bg-primary-600/10 border border-primary-600/30 rounded-lg",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-xs text-primary-400 mb-1",
                                                children: "💡 Test için doğrulama kodu:"
                                            }, void 0, false, {
                                                fileName: "[project]/app/verify-email/page.tsx",
                                                lineNumber: 229,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-lg font-mono font-bold text-primary-300 text-center",
                                                children: (()=>{
                                                    try {
                                                        const data = JSON.parse(localStorage.getItem("email-verification") || "{}");
                                                        return data.code || "Bulunamadı";
                                                    } catch  {
                                                        return "Bulunamadı";
                                                    }
                                                })()
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "(Bu kod sadece test için gösteriliyor)"
                                            }, void 0, false, {
                                                fileName: "[project]/app/verify-email/page.tsx",
                                                lineNumber: 240,
                                                columnNumber: 19
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd83fd38._.js.map